...
namespace MFilesAPI.Extensions
{
    ...
    public static partial class CustomApplicationExtensionMethods
    {
        ...
        public static List<CustomApplication> GetAllOtherChildApplications(this CustomApplication currentApplication, Vault vault)
        {
            // Sanity
            ...
            return vault.CustomApplicationManagementOperations
                        ...
                        .Where(_ => _.ID != currentApplication.ID && _.IsChildApplication())
                        .ToList();
        }
    }
}
